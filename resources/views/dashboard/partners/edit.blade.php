                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control image @error('image') is-invalid @enderror" type="file" id="formFile"
                                                ...
                                                <div class="form-group prev">
                                                    <img src="{{ Image::getImage('uploads/partners/',$partner->image) }}" style="width: 100px"
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="name_en" class="form-control @error('link') is-invalid @enderror" name="link" required
