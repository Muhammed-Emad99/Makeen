                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form form-vertical" id="createBookForm"
                                        action="{{ route('admin.partners.store') }}" method="POST" class="was-validated"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="link" class="form-control @error('link') is-invalid @enderror" name="link" required
                                                           value="{{ old('link') }}" />
                                                    @error('link')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
