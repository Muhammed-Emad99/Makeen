...
<link rel="stylesheet" type="text/css" href="{{ asset('dashboard/app-assets/magnific-popup/magnific-popup.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('dashboard/js/noty/noty.css') }}">
@stack('css')
