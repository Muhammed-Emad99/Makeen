                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a
                                            href="{{ route('admin.services.index') }}">الخدمات</a>
                                    </li>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea required
                                                              ...
                                                              rows="5">{{ old('description_ar',$service->description_ar) }}</textarea>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="form-group prev">
                                                    <img src="{{ Image::getImage('uploads/services/',$service->image) }}" style="width: 100px"
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="form-group  prev">
                                                    <img src="{{ Image::getImage('uploads/services/',$service->icon) }}" style="width: 100px"
                                                         class="img-thumbnail preview-formFile" alt="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label for="category_id">الوصف باللغه الانجليزيه</label>
                                                    <select
                                                        ...
                                                        @foreach($categories as $category)
                                                            <option
                                                                value="{{ $category->id }}" @selected($service->category_id == $category->id) >{{ $category->title_ar }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('category_id')
                                                    <div class="invalid-feedback">{{ $message }}</div>
