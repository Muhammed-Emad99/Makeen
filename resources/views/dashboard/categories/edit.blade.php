                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="title_ar" class="form-control @error('title_ar') is-invalid @enderror" name="title_ar"
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="title_en" class="form-control @error('title_en') is-invalid @enderror" name="title_en"
